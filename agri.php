...
<div style="background-image: url(img.webp);">
    <br>
    <h2 style="text-align: center; margin-right: 1%; text-decoration-line: none;">AGRICULTURE & RURAL</h2>
...
<div class="container">
    ...
    // Fetch data from the database where category is 'agriculture'
    $sql = "SELECT title, details, eligibility, benefits, application_procedures, document_required, further_details, further_benefits, category FROM schemes WHERE category = 'agriculture'";
