...
<html>
    ...
    <body>
        ...
        <div style="background-image: url(img3.webp);">
            <br>
            <h2 style="text-align: left; margin-left: 8%; text-decoration-line: none;">BUISNESS & ENTREPRENEURSHIP</h2>
    ...
    // Fetch data from the database where category is 'Business & Entrepreneurship'
    $sql = "SELECT title, details, eligibility, benefits, application_procedures, document_required, further_details, further_benefits, category FROM schemes WHERE category = 'Business & Entrepreneurship'";
