...
<html>
    ...
    <body>
        ...
        <div style="background-image: url(img3.webp);">
            <br>
            <h2 style="text-align: left; margin-left: 8%; text-decoration-line: none;">Women & Child</h2>
    ...
    // Fetch data from the database where category is 'Women & Child'
    $sql = "SELECT title, details, eligibility, benefits, application_procedures, documents_required, category FROM schemes WHERE category = 'Women & Child'";
